...
#     with open("/home/hyunggyu/imbalance/multi-domain-imbalance/mdlt/scripts/misc/vlcs_files.txt", "r") as f:
#         lines = f.readlines()
...
def download_office_home(data_dir):
    ...
    dst = os.path.join(data_dir, "office_home.zip")
    zf = ZipFile(dst, "r")
    zf.extractall(os.path.dirname(dst))
    zf.close()
...
def download_domain_net(data_dir):
    ...
    with open("/home/hyunggyu/imbalance/multi-domain-imbalance/mdlt/scripts/misc/domain_net_duplicates.txt", "r") as f:
...
# 2025.05.27
# Updated code for download (from DomainBed)
# Original URL:
# https://github.com/facebookresearch/DomainBed/blob/3cf2e20fb885f3ecf2e97b83268bb6c896568075/domainbed/scripts/download.py
